define([
  ...
  module.service('filterSrv', function($window, dashboard, ejsResource, sjsResource) {
    ...
    this.init = function() {
      ...
      if ($window.filter_field && self.ids.length < 1) {
         console.log("Added filter")
         self.set({
              type: 'terms',
              field: $window.filter_field,
              value: $window.filter_value
         });
      }
    };
